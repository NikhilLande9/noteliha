...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Listen to LanguageProvider so the whole tree rebuilds on language change.
      ...
      theme: ThemeData(
        ...
        cardTheme: baseCardTheme.copyWith(
          ...
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(14), side: lightBorder),
        ),
      ),
      darkTheme: ThemeData(
        useMaterial3: true,
        ...
        cardTheme: baseCardTheme.copyWith(
          color: darkBase,
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(14), side: darkBorder),
        ),
      ),
