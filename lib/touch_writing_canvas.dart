...
class DrawPoint {
  ...
  factory DrawPoint.fromJson(Map j) => DrawPoint((j['x'] as num).toDouble(),
      (j['y'] as num).toDouble(), (j['p'] as num? ?? 1.0).toDouble());
}
...
class TouchWritingCanvasState extends State<TouchWritingCanvas> {
  ...
  void _onPointerMove(PointerEvent e) {
    ...
    _active!.points
        .add(DrawPoint(e.localPosition.dx, e.localPosition.dy, _pressure(e)));
    setState(() {});
  }
  ...
  Color get _bgColor => widget.isDark ? const Color(0xFF1E2128) : Colors.white;
        ...
        _Toolbar(
          ...
          onClear: () => showDialog(
            ...
            builder: (ctx) => AlertDialog(
              title: Text(AppTranslations.translate('clear_canvas_title')),
              content: Text(AppTranslations.translate('clear_canvas_body')),
              actions: [
                TextButton(
                ...
                TextButton(
                    ...
                    child: Text(AppTranslations.translate('clear'),
          ...
          onExport: () async {
            ...
            if (bytes != null && context.mounted) {
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text(AppTranslations.translate('drawing_exported')),
        ...
        child: Row(
          children: [
            ...
            _ToolBtn(
              ...
              tooltip: AppTranslations.translate('pen'),
            ...
            _ToolBtn(
              ...
              tooltip: AppTranslations.translate('highlighter'),
            ...
            _ToolBtn(
              ...
              tooltip: AppTranslations.translate('eraser'),
            ...
            IconButton(
              ...
              tooltip: AppTranslations.translate('undo'),
            ...
            IconButton(
              ...
              tooltip: AppTranslations.translate('redo'),
            ...
            IconButton(
              ...
              tooltip: AppTranslations.translate('clear'),
              onPressed: onClear,
              iconSize: 20,
            ),
          ],
